...
$config = [
    ...
    'view_helpers'       => [
        ...
        'factories' => [
            ...
            View\Helper\Office\ContactLink::class        => View\Factory\ViewHelperFactory::class,
            View\Helper\Office\LeaveLink::class          => View\Factory\ViewHelperFactory::class,
    ...
    'service_manager'    => [
        'factories' => [
            ...
            Navigation\Invokable\Office\ContactLabel::class         => Factory\InvokableFactory::class,
            Navigation\Invokable\Office\LeaveLabel::class           => Factory\InvokableFactory::class,
