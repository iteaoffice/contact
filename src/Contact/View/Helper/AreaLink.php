...
/**
 * Create a link to an area
 *
 * @category    Contact
 * @package     View
 * @subpackage  Helper
 */
class AreaLink extends AbstractHelper
{
     ...
     * @throws \Exception
     */
    public function __invoke(Entity\Area $area = null, $action, $show)
    {
        ...
        switch ($action) {
            ...
            case 'edit':
                ...
                $text   = sprintf($translate("txt-edit-area-%s"), $area);
                break;
            case 'view':
                $router = 'contact/area';
                $text   = sprintf($translate("txt-view-area-%s"), $area);
                break;
            default:
